...
namespace Nutrition01
{
    ...
    public class DiseaseRRPersonInitializer
    {
        ...
        static int haveDiarrhea_offset= 0;
        static int haveAnemia_offset = 1;
        static int haveStunting_offset = 2;
    ...
    public class PersonDiseaseRRComparer : IEqualityComparer<Person>
    {
        ...
        public bool Equals(Person x, Person y)
        {
            ...
            return 
                x.getHaveDiarrheaNow() == y.getHaveDiarrheaNow() &&
                x.getHaveAnemiaNow() == y.getHaveAnemiaNow() &&
                x.getHaveStuntingNow() == y.getHaveStuntingNow();
        }
        ...
        public int GetHashCode(Person x)
        {
            if (x == null) return 0;
            double hashInput =
                1 * Convert.ToDouble(x.getHaveDiarrheaNow()) +
                2 * Convert.ToDouble(x.getHaveAnemiaNow()) +
                4 * Convert.ToDouble(x.getHaveStuntingNow());
