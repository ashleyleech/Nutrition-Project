...
namespace Nutrition01
{
    static class SimIO
    {
        static string file01_DiseasePrevalence_name;
        ...
        static string file06_Population_name;
        ...
        static public bool readCommandLineFile(string[] CommandLineArgs)
        {
            ...
            if (CommandLineArgs.Length != 1)
            {
                ...
                Console.WriteLine("1. Disease prevalence file");
            ...
            // to refer to.
            file01_DiseasePrevalence_name = fileReader.ReadLine();
            ...
            file06_Population_name = fileReader.ReadLine();
        ...
        static private bool otherFilesExist()
        {
            ...
            if (!File.Exists(file01_DiseasePrevalence_name))
            {
                otherFilesExist_errorMsg("Disease prevalence file", file01_DiseasePrevalence_name, 1);
                returnVal = false;
            }
            ...
            if (!File.Exists(file06_Population_name))
            {
                otherFilesExist_errorMsg("Population specification file", file06_Population_name, 6);
                returnVal = false;
            }
        ...
        {
            if (!readFile01_diseasePrevalence(file01_DiseasePrevalence_name)) return false;
            ...
            if (!readFile06_population(file06_Population_name)) return false;
            return true;
        }
        ...
        static private bool readFile02_mortRisk(string fileName)
        {
            ...
            while (inputRecord != null)
            {
                if (inputRecord != "")
                {
                    ...
                    // Get mortality risk, create a double initialized with this value.
                    ...
                    // If age >= 0 then go ahead and add entry to lookup table
                    //& Add the person object (key) and mortality risk (lookup value) to the dictionary.
                    if (myPerson.getageNow() >= 0) MortRisk.mortRiskTable.Add(myPerson, mortRisk);
                }
                inputRecord = fileReader.ReadLine();
                lineNum++;
            }

            // If mortRiskTable is empty, return with error
        ...
        static private bool readFile05_policies(string fileName)
        {
            ...
            // If policy file is empty, return with error
        ...
        /// <summary> //////////////////////////////////////////////////////////////////////////
        /// readFile06_population (simulation)
        /// Open and read in File06 - Population file.  Create Population list - one Person object
        /// per line of data read in.  Report out to console any problems.
        /// </summary> /////////////////////////////////////////////////////////////////////////
        static private bool readFile06_population(string fileName)
        {
            FileStream myFile = new FileStream(fileName, FileMode.Open, FileAccess.Read);
            StreamReader fileReader = new StreamReader(myFile);
            int lineNum = 2; // Keep track of where we are in the file in case there is a problem
